...
export default function Services() {
    ...
    return (
        <section id="About" className="about-section py-16 m-40 sm: m-5">
            <h2 className="text-2xl font-bold mb-4 text-center" data-aos="fade-up">{t('Home.about_section.title')}</h2>
